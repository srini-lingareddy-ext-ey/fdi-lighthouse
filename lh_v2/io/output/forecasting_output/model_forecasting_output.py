...
def save_model_forecast_forecasts(
    ...
    output_file_name = 'account_forecasts'
    ...
    forecasting_methods: list[aft.AccountForecastingMethodEnum] = []
    ...
    for account in account_forecasts.get_ordered_accounts():
        ...
        forecasting_methods.append(selected_methods[account])
